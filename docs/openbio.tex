...
\hypersetup{
  pdftitle={Foundations of Biology and Environmental Science: An Open-Access Encyclopedia},
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Load packages and data}
\CommentTok{\#install.packages("qqman")}
\FunctionTok{library}\NormalTok{(qqman)}
\FunctionTok{data}\NormalTok{(gwasResults)}

\CommentTok{\# \#\# Investigate results}
\CommentTok{\# dim(gwasResults)}
\CommentTok{\# names(gwasResults)}
\CommentTok{\# }
\CommentTok{\# }
\CommentTok{\# \#\# Distributio of P values}
\CommentTok{\# \#hist(gwasResults$P)}
\CommentTok{\# }
\CommentTok{\# \# Make Manhattan plot}
\CommentTok{\# manhattan(gwasResults)}

\FunctionTok{manhattan}\NormalTok{(gwasResults,}
          \AttributeTok{annotatePval =} \FloatTok{0.005}\NormalTok{, }
          \AttributeTok{main =} \StringTok{"Manhattan Plot"}\NormalTok{, }
          \AttributeTok{ylab =} \StringTok{"Significance"}\NormalTok{,}
          \AttributeTok{annotateTop =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\href{https://wp.biologos.org/wp-content/uploads/2018/10/venema_23_1.jpg}{\includegraphics{openbio_files/figure-latex/unnamed-chunk-6-1.pdf}}

\href{https://wp.biologos.org/wp-content/uploads/2018/10/venema_22_7.jpg}{\includegraphics{openbio_files/figure-latex/unnamed-chunk-7-1.pdf}}
...
\includegraphics{openbio_files/figure-latex/unnamed-chunk-8-1.pdf}
...
\includegraphics{openbio_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{openbio_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\includegraphics{openbio_files/figure-latex/unnamed-chunk-11-1.pdf}
